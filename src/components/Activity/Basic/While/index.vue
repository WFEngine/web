                ...
                <v-row class="ma-0">
                  <v-col cols="12" md="4" lg="4" xl="4">
                    <v-text-field
                      ...
                      outlined
                      :label="$t('activity.basic.while.leftItem')"
                  ...
                  <v-col cols="12" md="4" lg="4" xl="4">
                    <v-autocomplete
                      ...
                      item-value="Label"
                      outlined
                      :label="$t('activity.basic.while.operator')"
                    ></v-autocomplete>
                  </v-col>
                  <v-col cols="12" md="4" lg="4" xl="4">
                    <v-text-field
                      ...
                      "
                      outlined
                      :label="$t('activity.basic.while.rightItem')"
                  ...
                  <v-col cols="12" md="4" lg="4" xl="4">
                    <v-autocomplete
                      ...
                      item-value="type"
                      outlined
                      :label="$t('activity.basic.while.leftItemType')"
                    ></v-autocomplete>
                  </v-col>
                  ...
                  <v-col cols="12" md="4" lg="4" xl="4">
                    <v-autocomplete
                      ...
                      item-value="type"
                      outlined
                      :label="$t('activity.basic.while.rightItemType')"
                    ></v-autocomplete>
                  </v-col>
                  <v-col cols="12">
                    <v-card>
